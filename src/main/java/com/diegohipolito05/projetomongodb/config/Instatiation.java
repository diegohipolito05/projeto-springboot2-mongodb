...
public class Instatiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null, LocalDate.parse("2018-03-21"), "Partiu viagem", "Vou viajar para São Paulo. Abraços", maria);
		Post p2 = new Post(null, LocalDate.parse("2018-03-23"), "Bom dia", "Acordei feliz hoje", maria);
