package com.diegohipolito05.projetomongodb.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> objcectNotFound(ObjectNotFoundException e, HttpServletRequest request){
